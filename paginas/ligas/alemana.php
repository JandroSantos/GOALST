...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../../Assets/img/ico/bundes/favicon-16x16.png">
    ...
    try {
        ...
        if (!response.ok) {
                ...
                standings.forEach(equipo => {
                    ...
                    } else if (equipo.position >= 16 && equipo.position <= 20) {
