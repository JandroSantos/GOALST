...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../../Assets/img/ico/laliga/favicon-16x16.png">
...
<script>
    ...
    try {
        ...
        if (!response.ok) {
                ...
                console.log(data.standings[0].table.map(team => `ID: ${team.team.id}, Nombre: ${team.team.name}`));
